...
function printDB($db)
{
    ...
    $query = "select id_elec, id_vote, ward, district, lastname, firstname, middle, street_num, suffix_a, street_name, unit, phone, email, dob, party, reg_date, voted_2018, last_boe_election, num_boe_election, date_last_prim, num_prim, date_last_gen, num_gen, voting_jerry, volunteering, campaign_contr, transportation from $dbname.$table5";
